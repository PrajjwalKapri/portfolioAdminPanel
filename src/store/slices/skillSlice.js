...
export const getAllSkills = () => async (dispatch) => {
  ...
  try {
    const response = await axios.get(`${server}/api/v1/skill/getall`, {
...
export const addNewSkill = (data) => async (dispatch) => {
  ...
  try {
    const response = await axios.post(`${server}/api/v1/skill/add`, data, {
      withCredentials: true,
...
export const deleteSkill = (id) => async (dispatch) => {
  ...
  try {
    const response = await axios.delete(`${server}/api/v1/skill/delete/${id}`, {
      withCredentials: true,
    });
